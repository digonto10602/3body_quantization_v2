...
def plotter():
    ...
    QC_spec_drive = "/home/digonto/Codes/Practical_Lattice_v2/3body_quantization/test_files/QC_states_oneparams_fitting_L_20_L24/state0_fitting/"
    ...
    QC_state1 = QC_spec_drive + "QC_states_jackknifed_L_" + str(int(Lbyas)) + "_nP_000_energycutoff_0.39_one_param.dat"
    QC_state2 = QC_spec_drive + "QC_states_jackknifed_L_" + str(int(Lbyas)) + "_nP_100_energycutoff_0.39_one_param.dat"
    QC_state3 = QC_spec_drive + "QC_states_jackknifed_L_" + str(int(Lbyas)) + "_nP_110_energycutoff_0.39_one_param.dat"
    QC_state4 = QC_spec_drive + "QC_states_jackknifed_L_" + str(int(Lbyas)) + "_nP_111_energycutoff_0.39_one_param.dat"
    QC_state5 = QC_spec_drive + "QC_states_jackknifed_L_" + str(int(Lbyas)) + "_nP_200_energycutoff_0.39_one_param.dat"
