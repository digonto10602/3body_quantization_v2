...
def spectrum_plotter_with_L20andL24_with_QCstates(cutoff_val):
    ...
    for i in range(0,len(irrep_list),1):
        ...
        QC_drive = threebody_path + "/test_files/QC_states_oneparams_fitting_L_20_L24/state0_000_A1m_fitting/"
        QC_file1 = QC_drive + "QC_states_jackknifed_L_20_nP_" + moms + "_energycutoff_" + str(cutoff_val) + "_one_param.dat"
        QC_file2 = QC_drive + "QC_states_jackknifed_L_24_nP_" + moms + "_energycutoff_" + str(cutoff_val) + "_one_param.dat"
...
def diff_plotter(cutoff_val):
    ...
    for i in range(0,len(irrep_list),1):
        ...
        QC_drive = threebody_path + "/test_files/QC_states_oneparams_fitting_L_20_L24/state0_000_A1m_fitting/"
        QC_file1 = QC_drive + "QC_states_jackknifed_L_20_nP_" + mom_list[i] + "_energycutoff_" + str(cutoff_val) + "_one_param.dat"
        QC_file2 = QC_drive + "QC_states_jackknifed_L_24_nP_" + mom_list[i] + "_energycutoff_" + str(cutoff_val) + "_one_param.dat"
